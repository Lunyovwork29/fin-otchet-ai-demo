...
EXPENSE_RULES = [
    (r"аренд", "26", "Общехозяйственные расходы — аренда"),
    (r"электроэнерг|водоснабж|водоотвед", "26", "Общехозяйственные расходы — коммунальные услуги"),
    (r"зарплат", "70", "Расчёты с персоналом по оплате труда"),
    (r"страхов.*взнос", "69", "Расчёты по социальному страхованию"),
    (r"\bусн\b|налог", "68", "Расчёты по налогам и сборам"),
    (r"кредит|процент", "66", "Расчёты по кредитам и займам"),
    (r"материал", "10", "Материалы"),
    (r"реклам", "44", "Расходы на продажу — реклама"),
    (r"транспорт|достав", "44", "Расходы на продажу — транспорт"),
    (r"охран", "26", "Общехозяйственные расходы — охрана"),
    (r"комисси.*банк|банк.*комисси|расчётно-кассов", "26", "Общехозяйственные расходы — банковские услуги"),
    (r"канцеляр", "26", "Общехозяйственные расходы — канцтовары"),
    (r"ремонт", "26", "Общехозяйственные расходы — ремонт"),
    (r"связ|интернет", "26", "Общехозяйственные расходы — связь"),
]
INCOME_ACCOUNT = ("90.1", "Продажи (выручка)")
DEFAULT_EXPENSE_ACCOUNT = ("91.2", "Прочие расходы (не распознано)")
